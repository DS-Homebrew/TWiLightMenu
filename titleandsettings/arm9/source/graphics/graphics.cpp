...
void graphicsInit()
{
	...
	*(u16*)(0x0400006C) &= BIT(15);
	...
	vramcpy_ui (&BG_PALETTE_SUB[0], srloader_bannerPal, srloader_bannerPalLen);
	...
	/* mainBgTexID = glLoadTileSet(mainBgImage, // pointer to glImage array
								...
								(u16*) srloader_bannerPal, // Load our 256 color tiles palette
								(u8*) srloader_bannerBitmap // image data generated by GRIT
								); */
