...
STRING(DESCRIPTION_CARDREADDMA, "Games use DMA to do asynchrous read operations. Turn this off to work around crashes, at the cost of some game compatibility.")
...
STRING(DESCRIPTION_GAMEREGION, "Set region for DSi ROMs played using nds-bootstrap.")
