...
STRING(DESCRIPTION_CARDREADDMA, "Games use DMA to do asynchrous read operations. Turn this off to work around crashes in local multiplayer, at the cost of some game compatibility.")
