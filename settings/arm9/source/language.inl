...
STRING(FONT, "Font")
STRING(USE_THEME_FONT, "Use skin font")
...
STRING(DESCRIPTION_USE_THEME_FONT, "Use the font included in the skin (if it has one) instead of the one set by the \"Font\" setting.")
...
STRING(DESCRIPTION_SHOW_EMPTY_BOXES, "Show empty box slots in the Nintendo DSi, Nintendo 3DS, SEGA Saturn and Homebrew Launcher themes.")
...
STRING(DESCRIPTION_SHOW_PHOTO, "Show photos and screenshots on the top screen of the Nintendo DSi/3DS themes. This setting may be forcefully disabled in some skins.")
