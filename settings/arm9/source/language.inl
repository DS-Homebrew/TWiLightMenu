...
STRING(PHOTO_BOXART_COLOR_RANGE, "Photo & Box art color range")
...
STRING(DESCRIPTION_PHOTO_BOXART_COLOR_RANGE, "Adjust color range of the photo and/or box art/game covers. Set this to \"Low\" if you encounter a freeze in the DSi, 3DS, Saturn, or HBL UIs.")
