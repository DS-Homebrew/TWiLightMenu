...
STRING(WS_ROMS, "WonderSwan ROMs")
STRING(NGP_ROMS, "Neo Geo Pocket ROMs")
...
STRING(DESCRIPTION_SHOW_COL, "Display ColecoVision ROMs in the ROM list.")
STRING(DESCRIPTION_SHOW_M5, "Display Sord M5 ROMs in the ROM list.")
...
STRING(DESCRIPTION_SHOW_SG, "Display Sega SG-1000 ROMs in the ROM list.")
...
STRING(DESCRIPTION_SHOW_WS, "Display WonderSwan ROMs in the ROM list.")
STRING(DESCRIPTION_SHOW_NGP, "Display Neo Geo Pocket ROMs in the ROM list.")
