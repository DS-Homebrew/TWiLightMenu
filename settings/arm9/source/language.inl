...
STRING(DESCRIPTION_EXPANDROMSPACE_3DS, "Extends the ROM space in RAM from 24MB to 28MB, or for SDK5 games, 16MB to 28MB. Breaks a few games that fit in RAM. Breaks a few games that fit in RAM.")
