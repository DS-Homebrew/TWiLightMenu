...
STRING(LID_SOUND, "Lid Open/Close Sound")
...
STRING(PHOTO_BOXART_DITHER_LEVEL, "Photo & Box art dither level")
...
STRING(DESCRIPTION_LID_SOUND, "Play a sound effect when the console lid is closed and reopened.")
...
STRING(DESCRIPTION_PHOTO_BOXART_DITHER_LEVEL, "Adjust color dither level of the photo and box art/game covers. Set this to \"Normal\" if you encounter a freeze in the DSi, 3DS, Saturn, or HBL UIs.")
...
STRING(DESCRIPTION_GAMELOADER, "Select which application to use as the game loader to boot DS ROMs.")
...
STRING(SPLASH_EASTER_EGGS, "Splash Easter Eggs")
...
STRING(DESCRIPTION_SPLASH_EASTER_EGGS, "Different versions of the TWiLight Menu++ splash screen will be displayed on specific days (ex. anniversaries and holidays).")
STRING(DESCRIPTION_SPLASH_JINGLE_LENGTH, "Changes the length of the jingle played in the TWiLight Menu++ splash screen. Does not affect most easter eggs which use a different jingle.")
