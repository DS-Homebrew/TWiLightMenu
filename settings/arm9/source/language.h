...
extern std::string STR_DESCRIPTION_DSCLASSICMENU;
extern std::string STR_DESCRIPTION_SELECTBUTTONOPTION;
...
extern std::string STR_SAVEFATTABLECACHE;
...
extern std::string STR_DESCRIPTION_SAVEFATTABLECACHE;
