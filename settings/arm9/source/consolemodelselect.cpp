...
void LoadConsoleBMP(void) {
	...
	fileName = "nitro:/console_selector/consoleseltext_" + (language == 2 ? std::string("-fr") : std::string("")) + ".png";
...
bool consoleModel_isSure(int consoleModel) {
	...
	std::string fileName = "nitro:/console_selector/" + names[consoleModel - 1] + ".png";
	...
	int language = (ms().getGuiLanguage());
	fileName = "nitro:/console_selector/consoleseltext_areyousure" + (language == 2 ? std::string("-fr") : std::string("")) + ".png";
