...
std::string STR_DESCRIPTION_SHOW_VIDEO = "STR_DESCRIPTION_SHOW_VIDEO";
...
std::string STR_SAVEFATTABLECACHE = "STR_SAVEFATTABLECACHE";
...
std::string STR_DESCRIPTION_SAVEFATTABLECACHE = "STR_DESCRIPTION_SAVEFATTABLECACHE";
...
void langInit(void)
{
	...
	STR_DESCRIPTION_BLF = ConvertFromUTF8(languageini.GetString("LANGUAGE", "DESCRIPTION_BLF", "Decreases/Blocks blue light from coming through your screens, and reduces eye strain. This feature is experimental, so expect bugs."));
	...
	STR_DESCRIPTION_SHOW_VIDEO = ConvertFromUTF8(languageini.GetString("LANGUAGE", "DESCRIPTION_SHOW_VIDEO", "Display Rocket Video and MPEG4 files in the ROM list."));
	...
	STR_SAVEFATTABLECACHE = ConvertFromUTF8(languageini.GetString("LANGUAGE", "SAVEFATTABLECACHE", "Save FAT table cache"));
	...
	STR_DESCRIPTION_SAVEFATTABLECACHE = ConvertFromUTF8(languageini.GetString("LANGUAGE", "DESCRIPTION_SAVEFATTABLECACHE", "Saves the created FAT table cache as a 512KB file. If you soon encounter SD corruption, please turn this off."));
