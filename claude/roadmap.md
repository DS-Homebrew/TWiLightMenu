...
- **Elementos da tela superior:** só removemos o debug e colocamos a titlebox. Possíveis adições:
  box art do jogo, relógio/data, contador de jogos, mais info (região, tamanho).
...
- Ver [gotchas.md] antes de repetir tentativas de fonte/VRAM/PNG-runtime.
