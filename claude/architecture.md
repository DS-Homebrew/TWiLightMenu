...
- `arm9/source/graphics/ThemeTextures.cpp` — **fundos** (`drawTopBg`/`drawBottomBg`), **titlebox**
  (loader de BMP + `drawTopTitle`), carregamento de texturas do tema (`loadDSiTheme`), dialogbox.
