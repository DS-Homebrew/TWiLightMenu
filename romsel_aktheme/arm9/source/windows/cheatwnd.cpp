...
_List(0,0,w-8,h-44,this,"cheat tree", ms().ak_scrollSpeed)
{
	...
	ini.GetInt(Section, "selectionBarColor1", RGB15(16, 20, 24)),	// selectionBarColor1
	ini.GetInt(Section, "selectionBarColor2", RGB15(20, 25, 0))		// selectionBarColor2
	);
		...
		case KeyMessage::UI_KEY_LEFT:
			{
				...
				while (ii-- > 0) {
					if(_data[_indexes[ii]]._flags&cParsedItem::EFolder)
						break;
				}
				_List.selectRow(ii);
			}
