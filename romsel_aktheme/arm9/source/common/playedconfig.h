...
public:
    ...
    void updateRecentlyPlayed(const std::string dirName, const std::string newRecent);
    void incrementTimesPlayed(const std::string dirName, const std::string newRecent);
