...
#define TFN_FALLBACK_GRF_ICON_MSX            TFN_FALLBACK_UI_DIRECTORY"/grf/icon_msx.grf"
#define TFN_FALLBACK_GRF_ICON_MINI           TFN_FALLBACK_UI_DIRECTORY"/grf/icon_mini.grf"
