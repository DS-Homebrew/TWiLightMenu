...
STRING(BARSTOPPED_TURNOFF, "If the bar stopped, turn off\nthe POWER, and try again.")
...
STRING(SDK_VER_5, "SDK ver: 5 (TWLSDK)")
...
STRING(E_CODE, "This cheat uses E type codes\nand may not work or cause\nthe game to not launch.")
