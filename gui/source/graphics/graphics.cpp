...
#include "threedshome_sub.h"
#include "font6x8.h"
#include "../iconTitle.h"
#include "graphics.h"
#include "fontHandler.h"

extern bool dodrawIcon;
...
glImage titleBgImage[(256 / 16) * (256 / 16)];
...
void loadThemegraphics() {
	if (theme == 1) {
		subBgTexID = glLoadTileSet(subBgImage, // pointer to glImage array
								...
								GL_TEXTURE_WRAP_S | GL_TEXTURE_WRAP_T | TEXGEN_OFF | GL_TEXTURE_COLOR0_TRANSPARENT, // param for glTexImage2D() in videoGL.h
								256, // Length of the palette to use (256 colors)
								(u16*) threedshome_subPal, // Load our 256 color tiles palette
								(u8*) threedshome_subBitmap // image data generated by GRIT
								);
		mainBgTexID = glLoadTileSet(mainBgImage, // pointer to glImage array
									16, // sprite width
									16, // sprite height
